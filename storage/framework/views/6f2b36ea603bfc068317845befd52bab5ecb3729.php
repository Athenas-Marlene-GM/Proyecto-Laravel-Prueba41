		...
		<table class="table table-hover ml-4 mt-4">
			...
			<tbody>
				...
				<tr>
					...
					<form action="<?php echo e(route('entregas.update', $entrega->id)); ?>">
						<?php echo method_field('PATCH'); ?>
						<?php echo csrf_field(); ?>
						<td>
							<textarea name="comments" id=""><?php echo e($tarea->comments); ?></textarea>
						</td>
						<td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\Prueba41\resources\views/admin/tareas/show.blade.php ENDPATH**/ ?>